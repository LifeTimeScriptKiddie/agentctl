/**
 * Destructive / outward-facing intent detection shared by agentctl (approval
 * gate) and shared_ptr (memory write gate): one copy, so the two can't drift.
 */
import { normalizeForScan } from './untrusted.js';
